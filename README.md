...
当前项目提供 FastAPI 后端、React + TypeScript + Vite 前端、六大四字主菜单、统一布局、健康检查、系统管理、数据中心、Python 策略文件管理、代码编辑、接口检查、策略运行、信号展示、版本记录、单策略本地撮合回测、真实 QMT 只读数据链路，以及汇总资产、任务、信号、交易的总览看板。
